...
//                } else
                if (j == 0){
                    ...
                    if (i == 0) {
                        ...
                        params.width = 450;
                        String coverPrice = selectedcompanyArrayList.get(i - 1).getCoverPrice();
                        float price = Float.parseFloat(coverPrice);
                        if (coverPrice.equalsIgnoreCase("0")) {
                            String coverPrice1 = selectedcompanyArrayList.get(i - 1).getPrice();
                            float price1 = Float.parseFloat(coverPrice1);
                            heading = String.format("%s OMR", String.format(Locale.CANADA, "%.2f", price1));
                        } else {
                            heading = String.format("%s OMR", String.format(Locale.CANADA, "%.2f", price));
                        }
                    }
                    ...
                    if (i == 0) {
                        ...
                        params.width = 450;
                        heading = selectedcompanyArrayList.get(i-1).getCompanyTax();
                    }
                    ...
                    if (i == 0) {
                        ...
                        params.width = 450;
                        String coverPremium = selectedcompanyArrayList.get(i - 1).getCoverPrice();
                        heading = selectedcompanyArrayList.get(i-1).getCompanySelectedCoverPremium();
                    }
                    ...
                    if (i == 0) {
                        ...
                        apply.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                if (selectedcompanyList.getCoverPrice().equalsIgnoreCase("0")) {
                                    float price = Float.parseFloat(selectedcompanyList.getPrice());
                                    editor.putString(Constants.TOTAL_PREMIUM, String.valueOf(String.format(Locale.CANADA, "%.2f", price)));
                                } else {
                                    float price = Float.parseFloat(selectedcompanyList.getCoverPrice());
                                    editor.putString(Constants.TOTAL_PREMIUM, String.valueOf(String.format(Locale.CANADA, "%.2f", price)));
                                }
                                editor.putString(Constants.COMPANY_PRODUCT_ID, selectedcompanyList.getCompanyProductId());
                                editor.putString(Constants.COMPANY_NAME, selectedcompanyList.getCompanyName());
                                editor.apply();
