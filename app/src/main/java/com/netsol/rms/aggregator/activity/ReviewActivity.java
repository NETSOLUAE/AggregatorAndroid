...
//        int savedcompanyLogo = sharedPref.getInt(Constants.COMPANY_LOGO, 1);
        ...
        String currentDate = todayDate.substring(0,2);
        String currentMonth = todayDate.substring(3,5);
        int nextYear = Integer.parseInt(currentYear) + 1;
        int beforeDate = Integer.parseInt(currentDate) - 1;
        System.out.println(todayDate);

        String policyEndDate = String.valueOf(beforeDate) + "-" + currentMonth + "-" + String.valueOf(nextYear);

//        if (savedcompanyLogo != 1) {
//            companyLogo.setBackgroundResource(savedcompanyLogo);
//        }
        companyName.setText(savedcompanyName);
        policyStart.setText(String.format("Policy Starts: %s", todayDate));
        policyEnd.setText(String.format("Policy Ends: %s", policyEndDate));
