...
//        dbPassword = Encryption.toAscii(context);
    ...
    public void createDb() {
        ...
        db.execSQL("CREATE Table USER_INFO(ID TEXT, NAME TEXT, AGE TEXT, MOBILE TEXT, NATIONAL_ID TEXT, EMAIL TEXT, STATUS TEXT, COMPANY_ID TEXT, " +
        ...
        db.execSQL("CREATE Table COMPANY_DETAILS(PRODUCT_ID TEXT, INSURER_ID TEXT, LOB TEXT, PRODUCT_TYPE TEXT, PRODUCT_NAME TEXT, " +
                "EFFECTIVE_DATE TEXT, END_DATE TEXT, INSURER_NAME TEXT, TAX TEXT, SCHEME TEXT, TOTAL_PREMIUM TEXT, ATTRIBUTE TEXT, FEES TEXT, COVER_PREMIUM)");
    ...
    public void insertComanyDetails(CompanyDetails _companyDetails) {
        openConnection();
        try {
            String qryString = "Insert into COMPANY_DETAILS(PRODUCT_ID, INSURER_ID, LOB, PRODUCT_TYPE, PRODUCT_NAME, EFFECTIVE_DATE, END_DATE, INSURER_NAME, TAX, SCHEME, TOTAL_PREMIUM, " +
                    "ATTRIBUTE, FEES, COVER_PREMIUM) Values ('"
    ...
    public void insertUserInfo(UserInfo _userInfo) {
        openConnection();
        try {
            String qryString = "Insert into USER_INFO(ID, NAME, AGE, MOBILE, NATIONAL_ID, EMAIL, STATUS, COMPANY_ID, " +
