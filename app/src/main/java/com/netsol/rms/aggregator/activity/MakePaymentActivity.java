...
//                if (saveCard.isChecked()) {
                    ...
                    if (cardNoText.equalsIgnoreCase("") || expiryText.equalsIgnoreCase("")
                        ...
                        if(Integer.parseInt(expdate[0]) > 12){
                            ...
                            sendUserInformation(userIdFromDb, FULL_NAME, AGE, MOBILE_NUMBER, NATIONAL_ID, EMAIL, "Complete", COMPANY_PRODUCT_ID, VEHICLE_USAGE, VEHICLE_TYPE, VEHICLE_MAKE, MODEL,
...
//                }
    ...
    public void sendUserInformation(final String id, final String name, final String age, final String mobile_no, final String national_id, final String email, final String status,
                                    final String company_id, final String vehicle_usage, final String usage_type, final String make, final String modal, final String variant,
                                    final String rto, final String yom, final String price, final String registration_date) {
        try {
            AsyncServiceCall _companyDetails = new AsyncServiceCall() {
                ...
                protected Object doInBackground(Integer... params) {
                    ...
                    return _webServiceManager.sendUserInformation(id, name, age, mobile_no, national_id, email, status, company_id,
